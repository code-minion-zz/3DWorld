...
{	
	...
	float4 spec    = gSpecMap.SampleLevel( gTriLinearSam, pIn.texC, SamLevel );
	float3 normalT = gNormalMap.SampleLevel( gTriLinearSam, pIn.texC, SamLevel );
