...
DepthStencilState gOutsideStencil
{
	StencilEnable = true;
...
float4 colorShader(VS_OUT pIn) : SV_TARGET
{
	return pIn.color;
}
...
//{
//	//float3 difference = gEyePosW - pIn.posW;
...
//	}
//	
//	float4 diffuse = gDiffuseMap.SampleLevel( gTriLinearSam, pIn.texC, SamLevel );
//	
//	// Kill transparent pixels.
//	clip(diffuse.a - 0.15f);
//	
//	spec    = gSpecMap.SampleLevel( gTriLinearSam, pIn.texC, SamLevel );
//	normalT = gNormalMap.SampleLevel( gTriLinearSam, pIn.texC, SamLevel );
//	
//	// Map [0,1] --> [0,256]
//	spec.a *= 256.0f;
//	
...
technique10 ShadowTech
{
    pass P0
    {
		...
		SetPixelShader( CompileShader( ps_4_0, colorShader() ) );
    }
}
